    ...
    return (
        <>
            <div className="w-screen h-[10%] shadow-2xl fixed top-0 z-25">
                <div className="w-full h-full bg-[#035e17]">
                            ...
                            {links.map((item, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        ${active ? 'text-[#1eff44]' : 'text-[#FFFFFF]'}`}>
            ...
            {showProfile && (
                <div className="fixed inset-0 backdrop-blur-md flex justify-center items-center z-50"
                    ...
                    <div
                        className="flex flex-row bg-neutral-800/90 border-3 border-white rounded-3xl w-[80%] md:w-[65%] h-[75%] shadow-[0_0_25px_#001F91] text-white overflow-hidden"
                        ...
                        <div className="flex flex-col w-[65%] relative">
                            <div className="flex justify-end items-center h-[18%] pr-[5%] pt-[2%] space-x-[3%]">
                                {user && <div onClick={() => setShowLogoutPopup(true)} 
                                     className="bg-[#22a311] border-[#2a7b0d] border-3 #023e8a hover:opacity-60 px-4 py-2 rounded-xl cursor-pointer font-semibold">
                                    Logout
                                </div>}
                            ...
                            <div className="flex flex-col justify-center items-start h-[64%] border-y-3 border-white px-[10%]">
                                <div className="ml-5 mr-5 bg-[#87BDFF] text-[#27bb24] px-[10%] py-[3%] rounded-xl w-[90%] font-medium text-[1.8vw]">
                                    {username}
                                </div>
                            </div>

                            <div className="flex justify-center items-center h-[18%]">
                                <p className="text-[#42f566] text-4xl"
            ...
            {showLogoutPopup && (
                <div className="fixed inset-0 backdrop-blur-md flex justify-center items-center z-60"
                    ...
                    <div
                        className="bg-white border-4 border-[#16a922] rounded-2xl px-35 py-10 w-[80%] md:w-[40%] text-center shadow-lg"
                        onClick={(e) => e.stopPropagation()}>
                        <p className="text-xl text-[#0da121] font-semibold mb-6">
                            Are you sure to log out from {username} ?
                        </p>
                        <div className="flex justify-around">
                            <button
                                onClick={handleLogout}
                                className="bg-[#16a916] text-white border-2 px-6 py-3 rounded-xl hover:opacity-70">
                                Yes
                            </button>
                            <button
                                onClick={() => setShowLogoutPopup(false)}
                                className="bg-[#19d235] text-white border-2 px-6 py-3 rounded-xl hover:opacity-70">
                                No
                            </button>
                        </div>
                    </div>
